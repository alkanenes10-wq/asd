...
/**
 * Giriş / kayıt — DEMO GEÇİŞİ ile. Supabase bağlı olmadığı için form gönderimi
 * (ya da "demo ile devam") doğrudan panele düşürür. Supabase bağlandığında
 * bu formlar gerçek kimlik doğrulaması yapar.
 */
    ...
    <div className="grid min-h-dvh lg:grid-cols-[1.05fr_1fr]">
      ...
      <section className="relative flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm space-y-7">
          {/* Dar ekranda sol marka paneli gizlendiği için isim burada görünür. */}
          ...
          <form onSubmit={enter} className="space-y-4">
            {!isLogin && (
              <div className="space-y-1.5">
                ...
                <Input id="name" name="name" placeholder="Adınız Soyadınız" />
              </div>
            )}
            <div className="space-y-1.5">
              <Label htmlFor="email">{ui.email}</Label>
              <Input id="email" name="email" type="email" placeholder="siz@kliniginiz.com" defaultValue="demo@seansapp.com" />
            </div>
            <div className="space-y-1.5">
